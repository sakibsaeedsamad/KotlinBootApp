package com.sssakib.kotlinbootapp.view
...
import com.sssakib.kotlinbootapp.R
import com.sssakib.kotlinbootapp.model.ResponseModel
import com.sssakib.kotlinbootapp.model.User
import com.sssakib.kotlinbootapp.retrofit.RetrofitClient
...
class Registration : AppCompatActivity(), View.OnClickListener {
    ...
    fun doInsert() {
        ...
        val email = emailRegistrationET!!.text.toString().trim { it <= ' ' }
        val password =
            passwordRegistrationET!!.text.toString().trim { it <= ' ' }
        val address = addressRegistrationET!!.text.toString().trim { it <= ' ' }
        val img =
            """
